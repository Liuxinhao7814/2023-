...
QT_MOC_LITERAL(3, 20, 21), // "sendExceptionsToEmail"
QT_MOC_LITERAL(4, 42, 14) // "addDataToChart"

    },
    "Sensor\0dataChanged\0\0sendExceptionsToEmail\0"
    "addDataToChart"
};
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataChanged((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->sendExceptionsToEmail((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->addDataToChart((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Sensor::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sensor::dataChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Sensor::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sensor::sendExceptionsToEmail)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Sensor::dataChanged(float _t1)
{
...
// SIGNAL 1
void Sensor::sendExceptionsToEmail(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
